...
public class RequestLoanFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View root = inflater.inflate(R.layout.fragment1_request_loan, container, false);
        v = root;
